export class LegoColchets extends HTMLElement{
  static get observedAttributes(){
    ...
    connectedCallback(){
      ...
      td5.classList.add('border-top-1');
      td5.classList.add('border-right-1');
     
      td6.classList.add('border-bottom-1');
      tdC.classList.add('border-bottom-1');

      td7.classList.add('border-right-1');
      td7.classList.add('border-bottom-1');

    
     
      td1.style.width='2em';
      td2.style.width='2.8em';
      td3.style.width='2em';
      td4.style.width='2.8em';
      td5.style.width='2em';
      td6.style.width='2.8em';
      td7.style.width='2em';
      td8.style.width='2em';
      ...
      if(name==='vert'){
        ...
        if(newValue==='true'){
          ...
          const td6=this.querySelector('[data-id="td6"]');
            ...
            td2.classList.add('border-right-1')
            td4.classList.add('border-right-1')
            td6.classList.add('border-right-1')
        } 
